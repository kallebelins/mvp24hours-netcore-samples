...
namespace CustomerAPI.Application.Logic
{
    public class CustomerService : RepositoryPagingServiceAsync<Customer, IUnitOfWorkAsync>, ICustomerService
    {
        ...
        public async Task<IBusinessResult<GetByIdCustomerResponse>> GetById(string id, CancellationToken cancellationToken = default)
        {
            try
            {
        ...
        public async Task<IBusinessResult<string>> Create(CreateCustomerRequest dto, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IBusinessResult<int>> Update(string id, UpdateCustomerRequest dto, CancellationToken cancellationToken = default)
        {
