...
namespace CustomerAPI.WebAPI.Controllers
{
    ...
    public class CustomerController : BaseMvpController
    {
        ...
        public async Task<ActionResult<IBusinessResult<int>>> Create([FromBody] CreateCustomerRequest model, CancellationToken cancellationToken)
        {
        ...
        public async Task<ActionResult<IBusinessResult<int>>> Update(int id, [FromBody] UpdateCustomerRequest model, CancellationToken cancellationToken)
        {
