...
namespace CustomerAPI.Core.Resources {
    ...
    public class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Seed data cannot be processed. There is already data in the database..
        /// </summary>
        public static string RECORD_NOT_SEED_DATA {
            get {
                return ResourceManager.GetString("RECORD_NOT_SEED_DATA", resourceCulture);
            }
        }
    }
}
